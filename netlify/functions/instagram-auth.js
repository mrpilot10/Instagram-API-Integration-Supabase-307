...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    // ✅ Get user profile using Instagram API with enhanced fields
    console.log('🔄 Fetching user profile with enhanced fields...')
    const fields = [
      'id', 'username', 'name', 'account_type', 'media_count',
      'profile_picture_url', 'followers_count', 'follows_count', 'biography', 'website'
    ].join(',')
    ...
    // ✅ Get user media using Instagram API with enhanced fields
